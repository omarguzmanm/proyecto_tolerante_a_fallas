...
def registerUser():
    ...
    if request.method == 'POST':
        ...
        if account:
            ...
            conexion_MySQLdb = connectionBD()
            cursor = conexion_MySQLdb.cursor(dictionary=True)
            cursor.execute('INSERT INTO login_python (tipo_user, nombre, apellido, email, password, create_at) VALUES (%s, %s, %s, %s, %s, %s)', (tipo_user, nombre, apellido, email, password_encriptada,create_at))
